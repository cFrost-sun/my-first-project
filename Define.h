...
Base deifne file for generic 80C51 and 80C31 microcontroller, Must be included by all header files!
Copyright (c) cFrost.
All rights reserved.
--------------------------------------------------------------------------*/
#ifndef __DEFINE_H__
...
struct MODE
{
	UINT_8 warningTime;//报警持续时间
	UINT_8 sleepTime;//两次报警之间沉默时间
	UINT_8 enableConcentration;//报警起始浓度
	UINT_8 fanStartConcentration;//风扇启动浓度
};

#define BTN_NUM1_DOWN 0x11
#define BTN_NUM2_DOWN 0x12
#define BTN_NUM3_DOWN 0x13
#define BTN_UP_DOWN 0x14

#define BTN_NUM4_DOWN 0x21
#define BTN_NUM5_DOWN 0x22
#define BTN_NUM6_DOWN 0x23
#define BTN_DOWN_DOWN 0x24

#define BTN_NUM7_DOWN 0x31
#define BTN_NUM8_DOWN 0x32
#define BTN_NUM9_DOWN 0x33
#define BTN_LEFT_DOWN 0x34

#define BTN_OK_DOWN 0x41
#define BTN_NUM0_DOWN 0x42
#define BTN_CANCEL_DOWN 0x43
#define BTN_RIGHT_DOWN 0x44

#define SCR_SMOKECODE 0x00
#define SCR_SETUP 0x01
